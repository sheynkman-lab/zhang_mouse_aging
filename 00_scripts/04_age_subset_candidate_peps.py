...
final_filtered_data_with_informative.to_csv('./04_candidate_peps/subset_filtered_peptides_age_effects.csv', index=False)

print("Filtered peptide data saved to 'subset_filtered_peptides_age_effects.csv'.")
