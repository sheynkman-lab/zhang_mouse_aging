...
pep_map <- read_csv('../output/05_peptide_to_isoform_mapping/tryptic_peptide_to_mouse_protein_mapping.csv')

# read in experimentally identified peptides
experiment_files <- list.files(path='../output/04_make_clean_peptide_tables/', pattern='p*csv', full.names=TRUE)
...
write_csv(pep_map, '../output/06_isoform_annotation_of_experi_peptides/peptide_to_isoform_mapping_with_experimental_peptides.csv')
